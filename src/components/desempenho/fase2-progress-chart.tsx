...
export function Fase2ProgressChart({ points }: { points: Fase2ChartPoint[] }) {
    ...
    <div className="mt-4 rounded-lg border border-zinc-200 p-4 dark:border-zinc-800">
      ...
      <div className="relative mt-3">
        <svg
          ...
          role="img"
          aria-label="Gráfico de progresso da Fase 2: nível geral por simulado, na ordem cronológica"
          className="w-full"
        >
          {LEVEL_ORDER.map((level) => (
            <g key={level}>
